...
def serialize_embedding(embedding):
    return pickle.dumps(embedding)  # 将对象序列化，并返回一个字节对象


def deserialize_embedding(s):
    return pickle.loads(s)  # 从字节对象中读取被封装的对象
